...
//portas do Arduino para cada pino do LCD
const int rs = 8, en = 9, d4 = 4, d5 = 5, d6 = 6, d7 = 7;
LiquidCrystal lcd(rs, en, d4, d5, d6, d7); 

//temperaturaC ambiente do lugar em que estiver para que as LED's acendam com base nisso
int tempMin = 10;
...
void loop() {
  ...
  if(temperaturaC < tempMin){      //se a temperaturaC lida for inferior a 27 °C
    digitalWrite(10, LOW);            //acende led da porta 10 - Red
    digitalWrite(11, HIGH);            //apaga led da porta 11 - Green
        
  }else if(temperaturaC >= tempMax){  //se a temperaturaC lida estiver entre 27 ºC e 31 ºC
    digitalWrite(10, HIGH);           //apaga led da porta 10 - Red
    digitalWrite(11, LOW);            //acende led da porta 11 - Green
